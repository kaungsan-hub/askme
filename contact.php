...
<div class="blue_bg">
      ...
      <div class="about">
         <div class="container">
            <div class="row">
                  ...
                  <div class="about_text">
                     ...
                     <div class="col-md-4">
                        <ul class="conta_icon d_none1">
                           <li><img src="images/email.png" alt="#"/> kaungsan@gmail.com</li>
                        </ul>
                     </div>
                  </div>
               </div>
               <div class="col-md-7">
                  <div class="about_img">
                     <figure><img src="images/questionmark.png" alt="#"/></figure>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="container">
                  <div class="row">
                     <div class="col-md-4">
                        <ul class="conta_icon">
                           <li><a href="#"><img src="images/call.png" alt="#"/>Call us: +959444415779</a> </li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <div class="se_fonr1">                  
                           <span class="time_o"> Open Hour: 8AM - 8PM</span>
                        </div>
                     </div>
                  </div>
               </div>
